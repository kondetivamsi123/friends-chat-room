...
export const api = {
    ...
    getMessages: (channelId, sessionId) => callApi('/api/chat/messages', { channel_id: channelId, session_id: sessionId }),
    ...
    getChannels: (sessionId) => callApi('/api/chat/channels', { session_id: sessionId }),
